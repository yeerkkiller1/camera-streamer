            ...
            if(isArray(child)) {
                ...
                if(IsArrayInfinite(child)) {
                    ...
                    if(child.length !== data.length) {
                        throw new Error(`Template is array, but data isn't. Template is ${child.length}, data is ${data.length}`);
                    }
                        ...
                        boxes: [
                            {
                                ...
                                values: {
                                    ...
                                    default_sample_size: d.mdatContentSize,
